...
public class MississaugaHondaProvider : ICarSearchProvider
{
    private readonly MississaugaHondaSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<MississaugaHondaProvider> _logger;

    public string Name => "MississaugaHonda";
    public string DisplayName => "Mississauga Honda";
        ...
        ILogger<MississaugaHondaProvider> logger)
    {
        ...
        _options = options.Get("MississaugaHonda");
