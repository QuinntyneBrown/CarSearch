...
namespace CarSearch.Providers.MiltonNissan;

public class MiltonNissanProvider : ICarSearchProvider
{
    private readonly MiltonNissanSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<MiltonNissanProvider> _logger;

    public string Name => "MiltonNissan";
    public string DisplayName => "Milton Nissan";
    public bool IsEnabled => _options.Enabled;

    public MiltonNissanProvider(
        MiltonNissanSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<MiltonNissanProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("MiltonNissan");
