...
public class MercedesMississaugaSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            var listing = new VehicleListing
            {
                ...
                Dealer = "Mercedes-Benz Mississauga",
                Source = "MercedesMississauga"
            };
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.mercedes-benz-mississauga.ca" + urlMatch.Groups[1].Value;
