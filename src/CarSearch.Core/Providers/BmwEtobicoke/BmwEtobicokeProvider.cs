...
public class BmwEtobicokeProvider : ICarSearchProvider
{
    private readonly BmwEtobicokeSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<BmwEtobicokeProvider> _logger;

    public string Name => "BmwEtobicoke";
    public string DisplayName => "BMW Etobicoke";
        ...
        ILogger<BmwEtobicokeProvider> logger)
    {
        ...
        _options = options.Get("BmwEtobicoke");
