...
namespace CarSearch.Providers.ErinMillsAcura;

public class ErinMillsAcuraProvider : ICarSearchProvider
{
    private readonly ErinMillsAcuraSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<ErinMillsAcuraProvider> _logger;

    public string Name => "ErinMillsAcura";
    public string DisplayName => "Erin Mills Acura";
    public bool IsEnabled => _options.Enabled;

    public ErinMillsAcuraProvider(
        ErinMillsAcuraSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<ErinMillsAcuraProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("ErinMillsAcura");
