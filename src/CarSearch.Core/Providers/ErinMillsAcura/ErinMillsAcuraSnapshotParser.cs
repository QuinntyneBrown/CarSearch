...
public class ErinMillsAcuraSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.erinmillsacura.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Erin Mills Acura";
            listing.Source = "ErinMillsAcura";
