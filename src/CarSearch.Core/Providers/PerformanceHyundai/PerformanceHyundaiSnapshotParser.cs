...
public class PerformanceHyundaiSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.performancehyundaibrampton.com" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Performance Hyundai";
            listing.Source = "PerformanceHyundai";
