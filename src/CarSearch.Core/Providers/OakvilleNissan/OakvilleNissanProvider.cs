...
namespace CarSearch.Providers.OakvilleNissan;

public class OakvilleNissanProvider : ICarSearchProvider
{
    private readonly OakvilleNissanSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<OakvilleNissanProvider> _logger;

    public string Name => "OakvilleNissan";
    public string DisplayName => "Oakville Nissan";
    public bool IsEnabled => _options.Enabled;

    public OakvilleNissanProvider(
        OakvilleNissanSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<OakvilleNissanProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("OakvilleNissan");
