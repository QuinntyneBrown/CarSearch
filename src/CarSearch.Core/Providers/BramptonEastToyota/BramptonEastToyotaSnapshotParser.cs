...
public class BramptonEastToyotaSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://bramptoneasttoyota.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Brampton East Toyota";
            listing.Source = "BramptonEastToyota";
