...
namespace CarSearch.Providers.BramptonNorthNissan;

public class BramptonNorthNissanProvider : ICarSearchProvider
{
    private readonly BramptonNorthNissanSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<BramptonNorthNissanProvider> _logger;

    public string Name => "BramptonNorthNissan";
    public string DisplayName => "Brampton North Nissan";
    public bool IsEnabled => _options.Enabled;

    public BramptonNorthNissanProvider(
        BramptonNorthNissanSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<BramptonNorthNissanProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("BramptonNorthNissan");
