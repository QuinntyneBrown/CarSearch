...
public class JaguarThornhillProvider : ICarSearchProvider
{
    private readonly JaguarThornhillSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<JaguarThornhillProvider> _logger;

    public string Name => "JaguarThornhill";
    public string DisplayName => "Jaguar Thornhill";
        ...
        ILogger<JaguarThornhillProvider> logger)
    {
        ...
        _options = options.Get("JaguarThornhill");
