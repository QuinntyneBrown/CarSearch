...
public class AirportKiaProvider : ICarSearchProvider
{
    private readonly AirportKiaSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<AirportKiaProvider> _logger;

    public string Name => "AirportKia";
    public string DisplayName => "Airport Kia Mississauga";
    public bool IsEnabled => _options.Enabled;

    public AirportKiaProvider(
        AirportKiaSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<AirportKiaProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("AirportKia");
