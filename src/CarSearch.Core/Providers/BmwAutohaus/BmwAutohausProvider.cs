...
public class BmwAutohausProvider : ICarSearchProvider
{
    private readonly BmwAutohausSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<BmwAutohausProvider> _logger;

    public string Name => "BmwAutohaus";
    public string DisplayName => "BMW Autohaus Thornhill";
        ...
        ILogger<BmwAutohausProvider> logger)
    {
        ...
        _options = options.Get("BmwAutohaus");
