...
namespace CarSearch.Providers.PolicaroAcura;

public class PolicaroAcuraProvider : ICarSearchProvider
{
    private readonly PolicaroAcuraSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<PolicaroAcuraProvider> _logger;

    public string Name => "PolicaroAcura";
    public string DisplayName => "Policaro Acura Brampton";
    public bool IsEnabled => _options.Enabled;

    public PolicaroAcuraProvider(
        PolicaroAcuraSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<PolicaroAcuraProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("PolicaroAcura");
