...
public class PolicaroAcuraSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.policaroacura.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Policaro Acura";
            listing.Source = "PolicaroAcura";
