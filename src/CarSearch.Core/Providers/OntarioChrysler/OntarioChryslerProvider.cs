...
public class OntarioChryslerProvider : ICarSearchProvider
{
    private readonly OntarioChryslerSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<OntarioChryslerProvider> _logger;

    public string Name => "OntarioChrysler";
    public string DisplayName => "Ontario Chrysler Mississauga";
        ...
        ILogger<OntarioChryslerProvider> logger)
    {
        ...
        _options = options.Get("OntarioChrysler");
