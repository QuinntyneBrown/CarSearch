...
public class FormulaFordLincolnSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://formulafordlincoln.com" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Formula Ford Lincoln";
            listing.Source = "FormulaFordLincoln";
