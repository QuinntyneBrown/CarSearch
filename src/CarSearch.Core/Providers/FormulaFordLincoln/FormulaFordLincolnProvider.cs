...
namespace CarSearch.Providers.FormulaFordLincoln;

public class FormulaFordLincolnProvider : ICarSearchProvider
{
    private readonly FormulaFordLincolnSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<FormulaFordLincolnProvider> _logger;

    public string Name => "FormulaFordLincoln";
    public string DisplayName => "Formula Ford Lincoln Pickering";
    public bool IsEnabled => _options.Enabled;

    public FormulaFordLincolnProvider(
        FormulaFordLincolnSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<FormulaFordLincolnProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("FormulaFordLincoln");
