...
public class PerformanceInfinitiSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.performanceinfinitibrampton.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Performance INFINITI";
            listing.Source = "PerformanceInfiniti";
