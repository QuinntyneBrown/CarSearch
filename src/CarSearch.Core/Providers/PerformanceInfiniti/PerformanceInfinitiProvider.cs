...
namespace CarSearch.Providers.PerformanceInfiniti;

public class PerformanceInfinitiProvider : ICarSearchProvider
{
    private readonly PerformanceInfinitiSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<PerformanceInfinitiProvider> _logger;

    public string Name => "PerformanceInfiniti";
    public string DisplayName => "Performance INFINITI Brampton";
    public bool IsEnabled => _options.Enabled;

    public PerformanceInfinitiProvider(
        PerformanceInfinitiSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<PerformanceInfinitiProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("PerformanceInfiniti");
