...
public class NorthwestLexusSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.northwestlexus.com" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Northwest Lexus";
            listing.Source = "NorthwestLexus";
