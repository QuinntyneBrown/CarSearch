...
public class BuddsLandRoverSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            var listing = new VehicleListing
            {
                ...
                Dealer = "Budds' Land Rover Oakville",
                Source = "BuddsLandRover"
            };
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.buddslandrover.com" + urlMatch.Groups[1].Value;
