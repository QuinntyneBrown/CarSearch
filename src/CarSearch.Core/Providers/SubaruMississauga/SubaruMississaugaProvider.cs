...
namespace CarSearch.Providers.SubaruMississauga;

public class SubaruMississaugaProvider : ICarSearchProvider
{
    private readonly SubaruMississaugaSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<SubaruMississaugaProvider> _logger;

    public string Name => "SubaruMississauga";
    public string DisplayName => "Subaru of Mississauga";
    public bool IsEnabled => _options.Enabled;

    public SubaruMississaugaProvider(
        SubaruMississaugaSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<SubaruMississaugaProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("SubaruMississauga");
