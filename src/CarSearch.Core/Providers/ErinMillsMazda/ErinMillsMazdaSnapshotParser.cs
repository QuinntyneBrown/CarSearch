...
public class ErinMillsMazdaSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.erinmillsmazda.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Erin Mills Mazda";
            listing.Source = "ErinMillsMazda";
