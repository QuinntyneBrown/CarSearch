...
public class KiaOfBramptonSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.kiaofbrampton.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Kia of Brampton";
            listing.Source = "KiaOfBrampton";
