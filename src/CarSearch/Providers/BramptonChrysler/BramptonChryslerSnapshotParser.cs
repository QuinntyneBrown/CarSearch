...
namespace CarSearch.Providers.BramptonChrysler;

public class BramptonChryslerSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.bramptonchrysler.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Brampton Chrysler";
            listing.Source = "BramptonChrysler";
