...
public class RichmondHillChryslerSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.richmondhillchrysler.com" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Richmond Hill Chrysler";
            listing.Source = "RichmondHillChrysler";
