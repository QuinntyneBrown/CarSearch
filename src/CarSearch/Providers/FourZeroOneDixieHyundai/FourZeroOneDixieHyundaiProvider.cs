...
public class FourZeroOneDixieHyundaiProvider : ICarSearchProvider
{
    private readonly FourZeroOneDixieHyundaiSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<FourZeroOneDixieHyundaiProvider> _logger;

    public string Name => "FourZeroOneDixieHyundai";
    public string DisplayName => "401 Dixie Hyundai";
        ...
        ILogger<FourZeroOneDixieHyundaiProvider> logger)
    {
        ...
        _options = options.Get("FourZeroOneDixieHyundai");
    ...
    public async Task<ProviderSearchResult> SearchAsync(SearchParameters parameters, CancellationToken ct = default)
    {
        ...
        try
        {
            var inventoryUrl = _options.BaseUrl.TrimEnd('/') + "/used/";
