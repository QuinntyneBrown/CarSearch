...
public class MercedesMississaugaProvider : ICarSearchProvider
{
    private readonly MercedesMississaugaSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<MercedesMississaugaProvider> _logger;

    public string Name => "MercedesMississauga";
    public string DisplayName => "Mercedes-Benz Mississauga";
        ...
        ILogger<MercedesMississaugaProvider> logger)
    {
        ...
        _options = options.Get("MercedesMississauga");
