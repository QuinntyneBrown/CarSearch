...
namespace CarSearch.Providers.KiaOfBrampton;

public class KiaOfBramptonProvider : ICarSearchProvider
{
    private readonly KiaOfBramptonSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<KiaOfBramptonProvider> _logger;

    public string Name => "KiaOfBrampton";
    public string DisplayName => "Kia of Brampton";
    public bool IsEnabled => _options.Enabled;

    public KiaOfBramptonProvider(
        KiaOfBramptonSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<KiaOfBramptonProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("KiaOfBrampton");
