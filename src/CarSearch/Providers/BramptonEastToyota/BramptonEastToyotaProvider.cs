...
namespace CarSearch.Providers.BramptonEastToyota;

public class BramptonEastToyotaProvider : ICarSearchProvider
{
    private readonly BramptonEastToyotaSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<BramptonEastToyotaProvider> _logger;

    public string Name => "BramptonEastToyota";
    public string DisplayName => "Brampton East Toyota";
    public bool IsEnabled => _options.Enabled;

    public BramptonEastToyotaProvider(
        BramptonEastToyotaSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<BramptonEastToyotaProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("BramptonEastToyota");
