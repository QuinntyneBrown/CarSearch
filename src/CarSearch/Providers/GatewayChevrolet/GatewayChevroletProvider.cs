...
public class GatewayChevroletProvider : ICarSearchProvider
{
    private readonly GatewayChevroletSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<GatewayChevroletProvider> _logger;

    public string Name => "GatewayChevrolet";
    public string DisplayName => "Gateway Chevrolet Brampton";
        ...
        ILogger<GatewayChevroletProvider> logger)
    {
        ...
        _options = options.Get("GatewayChevrolet");
    ...
    public async Task<ProviderSearchResult> SearchAsync(SearchParameters parameters, CancellationToken ct = default)
    {
        ...
        try
        {
            var inventoryUrl = _options.BaseUrl.TrimEnd('/') + "/inventory/used/";
