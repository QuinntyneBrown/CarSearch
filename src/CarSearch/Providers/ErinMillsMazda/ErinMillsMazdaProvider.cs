...
namespace CarSearch.Providers.ErinMillsMazda;

public class ErinMillsMazdaProvider : ICarSearchProvider
{
    private readonly ErinMillsMazdaSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<ErinMillsMazdaProvider> _logger;

    public string Name => "ErinMillsMazda";
    public string DisplayName => "Erin Mills Mazda";
    public bool IsEnabled => _options.Enabled;

    public ErinMillsMazdaProvider(
        ErinMillsMazdaSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<ErinMillsMazdaProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("ErinMillsMazda");
