...
public class MaranelloBmwProvider : ICarSearchProvider
{
    private readonly MaranelloBmwSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<MaranelloBmwProvider> _logger;

    public string Name => "MaranelloBmw";
    public string DisplayName => "Maranello BMW Vaughan";
        ...
        ILogger<MaranelloBmwProvider> logger)
    {
        ...
        _options = options.Get("MaranelloBmw");
