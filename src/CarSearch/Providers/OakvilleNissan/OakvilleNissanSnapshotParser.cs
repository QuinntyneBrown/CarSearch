...
public class OakvilleNissanSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.oakvillenissan.com" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Oakville Nissan";
            listing.Source = "OakvilleNissan";
