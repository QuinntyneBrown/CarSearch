...
public class MississaugaHyundaiProvider : ICarSearchProvider
{
    private readonly MississaugaHyundaiSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<MississaugaHyundaiProvider> _logger;

    public string Name => "MississaugaHyundai";
    public string DisplayName => "Mississauga Hyundai";
        ...
        ILogger<MississaugaHyundaiProvider> logger)
    {
        ...
        _options = options.Get("MississaugaHyundai");
