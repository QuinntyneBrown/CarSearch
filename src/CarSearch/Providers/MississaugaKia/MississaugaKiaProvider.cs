...
namespace CarSearch.Providers.MississaugaKia;

public class MississaugaKiaProvider : ICarSearchProvider
{
    private readonly MississaugaKiaSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<MississaugaKiaProvider> _logger;

    public string Name => "MississaugaKia";
    public string DisplayName => "Mississauga Kia";
    public bool IsEnabled => _options.Enabled;

    public MississaugaKiaProvider(
        MississaugaKiaSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<MississaugaKiaProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("MississaugaKia");
