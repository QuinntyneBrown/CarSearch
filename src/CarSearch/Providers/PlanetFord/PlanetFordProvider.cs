...
namespace CarSearch.Providers.PlanetFord;

public class PlanetFordProvider : ICarSearchProvider
{
    private readonly PlanetFordSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<PlanetFordProvider> _logger;

    public string Name => "PlanetFord";
    public string DisplayName => "Planet Ford Brampton";
    public bool IsEnabled => _options.Enabled;

    public PlanetFordProvider(
        PlanetFordSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<PlanetFordProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("PlanetFord");
