...
namespace CarSearch.Providers.PerformanceHyundai;

public class PerformanceHyundaiProvider : ICarSearchProvider
{
    private readonly PerformanceHyundaiSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<PerformanceHyundaiProvider> _logger;

    public string Name => "PerformanceHyundai";
    public string DisplayName => "Performance Hyundai Brampton";
    public bool IsEnabled => _options.Enabled;

    public PerformanceHyundaiProvider(
        PerformanceHyundaiSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<PerformanceHyundaiProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("PerformanceHyundai");
