...
namespace CarSearch.Providers.AcuraNorthMississauga;

public class AcuraNorthMississaugaProvider : ICarSearchProvider
{
    private readonly AcuraNorthMississaugaSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<AcuraNorthMississaugaProvider> _logger;

    public string Name => "AcuraNorthMississauga";
    public string DisplayName => "Acura North Mississauga";
    public bool IsEnabled => _options.Enabled;

    public AcuraNorthMississaugaProvider(
        AcuraNorthMississaugaSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<AcuraNorthMississaugaProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("AcuraNorthMississauga");
