...
public class AcuraNorthMississaugaSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.acuranorthmississauga.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Acura North Mississauga";
            listing.Source = "AcuraNorthMississauga";
