...
public class ParkviewBmwProvider : ICarSearchProvider
{
    private readonly ParkviewBmwSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<ParkviewBmwProvider> _logger;

    public string Name => "ParkviewBmw";
    public string DisplayName => "Parkview BMW Toronto";
        ...
        ILogger<ParkviewBmwProvider> logger)
    {
        ...
        _options = options.Get("ParkviewBmw");
