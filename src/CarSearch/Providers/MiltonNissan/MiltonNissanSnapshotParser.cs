...
public class MiltonNissanSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.miltonnissan.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Milton Nissan";
            listing.Source = "MiltonNissan";
