...
public class JaguarTorontoSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://jaguartoronto.com" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Jaguar Toronto";
            listing.Source = "JaguarToronto";
