...
public class PeelChryslerSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.peelchryslerjeep.com" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Peel Chrysler";
            listing.Source = "PeelChrysler";
