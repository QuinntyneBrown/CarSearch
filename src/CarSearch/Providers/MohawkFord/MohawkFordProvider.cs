...
namespace CarSearch.Providers.MohawkFord;

public class MohawkFordProvider : ICarSearchProvider
{
    private readonly MohawkFordSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<MohawkFordProvider> _logger;

    public string Name => "MohawkFord";
    public string DisplayName => "Mohawk Ford Hamilton";
    public bool IsEnabled => _options.Enabled;

    public MohawkFordProvider(
        MohawkFordSnapshotParser parser,
        IServiceProvider serviceProvider,
        IOptionsSnapshot<ProviderOptions> options,
        IOptions<PlaywrightCliOptions> cliOptions,
        ILogger<MohawkFordProvider> logger)
    {
        _parser = parser;
        _serviceProvider = serviceProvider;
        _options = options.Get("MohawkFord");
