...
public class LandRoverMetroWestProvider : ICarSearchProvider
{
    private readonly LandRoverMetroWestSnapshotParser _parser;
    private readonly IServiceProvider _serviceProvider;
    private readonly ProviderOptions _options;
    private readonly PlaywrightCliOptions _cliOptions;
    private readonly ILogger<LandRoverMetroWestProvider> _logger;

    public string Name => "LandRoverMetroWest";
    public string DisplayName => "Land Rover Metro West";
        ...
        ILogger<LandRoverMetroWestProvider> logger)
    {
        ...
        _options = options.Get("LandRoverMetroWest");
