...
public class BramptonNorthNissanSnapshotParser
{
    ...
    public List<VehicleListing> ParseListings(string yaml)
    {
        ...
        while (i < lines.Length)
        {
            ...
            if (urlMatch.Success)
                listing.Url = "https://www.bramptonnorthnissan.ca" + urlMatch.Groups[1].Value;
            ...
            listing.Dealer = "Brampton North Nissan";
            listing.Source = "BramptonNorthNissan";
